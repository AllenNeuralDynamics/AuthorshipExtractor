...
- **Collaboration views** — chord diagram (spectral-ordered to reduce crossings), force-directed collaboration layout (proximity = shared work), and circle-of-circles views by institution, role, or section
