...
Yet none of these efforts have changed what the reader actually sees. Our framework addresses this missing layer: six interactive views that let readers explore contributions from multiple angles, shifting the message from "these authors are ranked" to "these authors contributed along dimensions you can explore."
