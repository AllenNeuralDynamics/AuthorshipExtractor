...
A central design principle is that there is no single correct author ordering. The Sorted List view makes this tangible: a reader interested in who led the conceptualization can sort by that role; a hiring committee can sort by Software; a student can sort by Methodology. By making re-sorting immediate, we shift the message from "these authors are ranked" to "these authors contributed along multiple dimensions that you can explore."
